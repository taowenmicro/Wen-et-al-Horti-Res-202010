...
p <- MultiFunctionTaxaContributionPlots(input_dir="E:/Shared_Folder/HG_kangbing/nobac_noqianheti_chuli/fishtaco_input/使用fishtaco结果作分析/B80富集的通路统计分析/运行fishtaco文件/第四次结果B80富集通路",
                                        input_prefix="fishtaco_out_no_inf",
                                        input_taxa_taxonomy="E:/Shared_Folder/HG_kangbing/nobac_noqianheti_chuli/fishtaco_input/使用fishtaco结果作分析/B80富集的通路统计分析/运行fishtaco文件/第四次结果B80富集通路/tax_100.txt", sort_by="list", plot_type="bars",
...
p <- MultiFunctionTaxaContributionPlots(input_dir="E:/Shared_Folder/HG_kangbing/nobac_noqianheti_chuli/fishtaco_input/chongxinyunxign/第四次结果B80富集通路",
                                        input_prefix="fishtaco_out_no_inf",
                                        input_taxa_taxonomy="E:/Shared_Folder/HG_kangbing/nobac_noqianheti_chuli/fishtaco_input/第三次fishtacomulti_taxa/tax_100.txt", sort_by="list", plot_type="bars",
                                        input_function_filter_list=c("ko00020",
                                                                     "ko00250",
                                                                     "ko00290",
                                                                     "ko00620",
